...
<div id="main-content">
    <div class="main-content-region">
        <div class="admin-options-region">
            ...
            <a class="steps-button" href="<?php echo \Vendi\Shared\template_router::get_instance()->create_url('add-edit-ad'); ?>"> Create An Ad </a>
            <a class="steps-button" href="<?php echo \Vendi\Shared\template_router::get_instance()->create_url('report'); ?>"> Check Member Balances </a>
        ...
        <div class="flier-region">
            ...
            if(count($date_organized_posts) > 0){
                foreach($date_organized_posts as $date => $id_arr){
                    ...
                    $htmlstring .= '<div class="grey-bottom-border"><h1>Flier for ' . $date . '</h1><a class="steps-button" href="'. \Vendi\Shared\template_router::get_instance()->create_url('preview', [ 'date' => str_replace("/", "_", $date) ] ) . '"> Prepare flier </a>';
                    ...
                    foreach ($id_arr as $id) {
                        ...
                        $htmlstring .= ' <a class="" href="'. \Vendi\Shared\template_router::get_instance()->create_url('add-edit-ad', ['post_id' => $id ] ) . '">';
                ...
                $htmlstring .= '<div class="admin-view-box">';
                $htmlstring .= '<div class="grey-bottom-border"><h1>Flier for ' . $formatted_date . '</h1><a class="steps-button" href="'. \Vendi\Shared\template_router::get_instance()->create_url('preview', [ 'date' => str_replace("/", "_", $formatted_date) ] ) . '"> Prepare flier </a>';
