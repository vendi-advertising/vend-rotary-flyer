<?php
/*
Code for using templates from the plugin in addition to those from the theme
Auth: WPExplorer
Auth URI: http://www.wpexplorer.com/
Code URL: http://www.wpexplorer.com/wordpress-page-templates-plugin/
*/
